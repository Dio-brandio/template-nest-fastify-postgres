...
const responseDecorator = async (fastify) => {
  fastify.decorateReply(
    'ok',
    function (data: any = null, message = Messages.successMessage) {
  ...
  fastify.decorateReply(
    'created',
    function (data: any = null, message = Messages.recordCreatedSuccessfully) {
  ...
  fastify.decorateReply(
    'badRequest',
    function (message = 'Bad request', data: any = null) {
  ...
  fastify.decorateReply(
    ...
    function (message = 'Not sufficient permission', data: any = null) {
  ...
  fastify.decorateReply(
    'error',
    function (message = Messages.internalServerError, data: any = null) {
